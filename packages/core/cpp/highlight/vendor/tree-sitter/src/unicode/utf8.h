...
#define U8_COUNT_TRAIL_BYTES(leadByte)                                                                                 \
  (U8_IS_LEAD(leadByte) ? ((uint8_t)(leadByte) >= 0xe0) + ((uint8_t)(leadByte) >= 0xf0) + 1 : 0)
    ...
    if (!U8_IS_SINGLE(c)) {                                                                                            \
      ...
      if ((i) != (length) &&           /* fetch/validate/assemble all but last trail byte */                           \
          ((c) >= 0xe0 ? ((c) < 0xf0 ? /* U+0800..U+FFFF except surrogates */                                          \
                              U8_LEAD3_T1_BITS[(c) &= 0xf] & (1 << ((__t = (s)[i]) >> 5)) && (__t &= 0x3f, 1)          \
                                     : /* U+10000..U+10FFFF */                                                         \
                              ((c) -= 0xf0) <= 4 && U8_LEAD4_T1_BITS[(__t = (s)[i]) >> 4] & (1 << (c)) &&              \
  ...
  UPRV_BLOCK_MACRO_BEGIN {                                                                                             \
    ...
    if (U8_IS_LEAD(__b) && (i) != (length)) {                                                                          \
      ...
      if ((0xe0 <= __b && __b < 0xf0)) {                                                                               \
        if (U8_IS_VALID_LEAD3_AND_T1(__b, __t1) && ++(i) != (length) && U8_IS_TRAIL((s)[i])) {                         \
          ++(i);                                                                                                       \
        }                                                                                                              \
      } else if (__b < 0xe0) {                                                                                         \
        if (U8_IS_TRAIL(__t1)) {                                                                                       \
        ...
        if (U8_IS_VALID_LEAD4_AND_T1(__b, __t1) && ++(i) != (length) && U8_IS_TRAIL((s)[i]) && ++(i) != (length) &&    \
            U8_IS_TRAIL((s)[i])) {                                                                                     \
          ++(i);                                                                                                       \
        }                                                                                                              \
      }                                                                                                                \
    ...
    if ((length) > (start)) {                                                                                          \
      ...
      if (U8_IS_SINGLE(__b1)) {                                                                                        \
        ...
        if (0xe0 <= __b2 && __b2 <= 0xf4) {                                                                            \
          if (__b2 < 0xf0 ? U8_IS_VALID_LEAD3_AND_T1(__b2, __b1) : U8_IS_VALID_LEAD4_AND_T1(__b2, __b1)) {             \
            (length) -= 2;                                                                                             \
          }                                                                                                            \
