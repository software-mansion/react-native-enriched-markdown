...
typedef uint32_t (*TSDecodeFunction)(const uint8_t *string, uint32_t length, int32_t *code_point);
 ...
 */
TSTree *ts_parser_parse_with_options(TSParser *self, const TSTree *old_tree, TSInput input,
 ...
 */
TSQuery *ts_query_new(const TSLanguage *language, const char *source, uint32_t source_len, uint32_t *error_offset,
 ...
 */
const TSQueryPredicateStep *ts_query_predicates_for_pattern(const TSQuery *self, uint32_t pattern_index,
                                                            uint32_t *step_count);
 ...
 */
void ts_query_cursor_exec_with_options(TSQueryCursor *self, const TSQuery *query, TSNode node,
 ...
 */
const TSLanguage *ts_wasm_store_load_language(TSWasmStore *, const char *name, const char *wasm, uint32_t wasm_len,
                                              TSWasmError *error);
 ...
 */
void ts_set_allocator(void *(*new_malloc)(size_t), void *(*new_calloc)(size_t, size_t),
